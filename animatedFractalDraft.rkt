...
(define xw2sscale 0.2)
(define yw2sscale 0.2)
(define xw2soffset 1024)
(define yw2soffset (+ 288 288))
...
(define (drawTri a b c d e f i)
  ...
  (send Tri scale (expt xw2sscale (/ i 2)) (expt yw2sscale (/ i 2)))
  ;get rid of these conditionals after testing
  (cond [(= f 50000)
  (display (expt xw2sscale (/ i 10)))]
  (newline))
  (cond [(= f 50000)
         (newline)
  (display (expt xw2sscale (/ i 10)))]
...
; put the for list back into operation after testing
;(for/list ([i 600])
; after testing, the final parem should be i + 1 !!!!!!!!!!!!
  (fractal 1900 950 2448 1100 1800 50000 600)
  ;after testing, the 600 should be changed to i
  (define outName (makeoutputname 200  "myFractal"))
  myTarget
